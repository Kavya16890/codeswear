...
const Navbar = ({ cart, addToCart, removeFromCart, clearCart, subTotal }) => {
  ...
  const ref = useRef();
  return (
    <div className="flex flex-col justify-center md:flex-row md:justify-start items-center py-2 shadow-md sticky top-0 bg-white z-10">
      ...
      <div
        ...
        <div className="flex">
          ...
          >
            {/* <a className="flex mr-2 text-white bg-pink-500 border-0 py-2 px-3 focus:outline-none hover:bg-pink-600 rounded text-sm"> */}
            <IoBagCheckOutline className="text-xl m-2" />
          ...
          <button
            ...
            onClick={clearCart}
          >
            <IoIosRemoveCircle className="m-1 text-3xl" />
            Clear Cart
          </button>
        </div>
      </div>
